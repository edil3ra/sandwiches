...
** Fake [9/9]
   ...
   + [X] create commands
   + [X] create orders
   + [ ] Refactor the command for the change status
   + [ ] Refactor the create foods to create foods by shop
   + [ ] Create a default list for food items to make it more realist
   + [ ] Change the variable for the name of the foods
